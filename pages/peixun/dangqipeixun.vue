<template>
		<view class="content">
			...
			<view class="uni-bm-box">
				<image src="../../static/pege_2_1.jpg" mode=""></image>
			</view>
			...
			<view class="uni-kc-list" :hidden="!iscart">
				<view class="uni-kc-item" v-for="(item,index) in kclist" :key="index" @tap="openkc(item.ID, item.TrainName)" :data-pxid="item.ID">
